...
namespace FrostAura.Services.Devices.Core.Extensions
{
    /// <summary>
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        {
            return services
                .AddSingleton<IMqttManager, DeviceAttributeMqttManager>()
                .AddSingleton<IPayloadManager, JsonStringPayloadManager>()
